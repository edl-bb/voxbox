...
- Improved on-device transcript cleanup.
    ...
    - Punctuation is placed by meaning, not by pauses. Speech engines end a sentence wherever the speaker breathed, which leaves fragments like "…faster sections. And the pauses…". Every level is now told the dictation's punctuation is only a suggestion, Polish is told to read the whole passage and re-punctuate it as one considered piece, and Polish also folds a sentence that starts with "And", "But", "Because", "Which" or "Or" back onto the sentence before it.
